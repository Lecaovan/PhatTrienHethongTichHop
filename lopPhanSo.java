...
public class lopPhanSo {
	...
	public lopPhanSo() // ham khoi tao khong tham so
	{
		tu = 0;
		mau = 1;
	}

	public lopPhanSo(int x) // khoi tao mot tham so
	{
		tu = x;
		mau = 1;
	}

	public lopPhanSo(int a, int b) // khoi tao hai tham so
	{
		tu = a;
		mau = b;
	}
	...
	public lopPhanSo CongPS(lopPhanSo ps10) // tong cua 2 phan so
	{
		int ts = tu * ps10.mau + mau * ps10.tu;
		int ms = mau * ps10.mau;
		lopPhanSo ketqua = new lopPhanSo(ts, ms);
		return (ketqua);
	}

	public lopPhanSo TruPS(lopPhanSo ps1) {
	...
	public lopPhanSo NhanPS(lopPhanSo ps1) {
		int ts = tu * ps1.tu;
		int ms = mau * ps1.mau;
		lopPhanSo ketqua = new lopPhanSo(ts, ms);
		return (ketqua);
	...
	public lopPhanSo ChiaPS(lopPhanSo ps1) {
		int ts = tu * ps1.mau;
		int ms = mau * ps1.tu;
		lopPhanSo ketqua = new lopPhanSo(ts, ms);
		return (ketqua);
	...
	public static void main(String[] args) throws IOException {
		...
		String e;
		int chon, a, d, c;
		lopPhanSo ps = new lopPhanSo();
		lopPhanSo ps1 = new lopPhanSo(1,2);
		lopPhanSo ps2 = new lopPhanSo(3,4);
